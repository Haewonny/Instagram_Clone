        ...
        <div className="suggestions__container">
          ...
          <div className="suggestions__body">
            ...
            <div className="suggestions__friends">
              ...
              <div className="suggestions__username">ewha.w.univ</div>
            </div>
            <div className="suggestions__friends">
              <Avatar src={imageSrc3} className="suggestions__image" />
              <div className="suggestions__username">coding</div>
            </div>
            <div className="suggestions__friends">
              <Avatar src={imageSrc2} className="suggestions__image" />
              <div className="suggestions__username">ewha.cse</div>
            </div>
            <div className="suggestions__friends">
              <Avatar src={imageSrc3} className="suggestions__image" />
              <div className="suggestions__username">sun_w0n</div>
            </div>
            <div className="suggestions__friends">
              <Avatar src={imageSrc1} className="suggestions__image" />
              <div className="suggestions__username">hello_world</div>
            </div>
          </div>
        </div>
      </div>
